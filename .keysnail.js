...
plugins.options["kkk.sites"] =
    ["^https?://([0-9a-zA-Z]+\\.)?google\\.([0-9a-zA-Z/_-]+)",
     "^https?://([0-9a-zA-Z]+\\.)?github\\.(.+)",
     "^https?://([0-9a-zA-Z]+\\.)?bitbucket\\.([0-9a-zA-Z/_-]+)",
     "^https?://([0-9a-zA-Z]+\\.)?facebook\\.([0-9a-zA-Z/_-]+)",
     "^https?://([0-9a-zA-Z]+\\.)?reddit\\.([0-9a-zA-Z/_-]+)/submit.*",
     "^https?://([0-9a-zA-Z-]+)\\.slack\\.com(.*)",
     "^https?://(.+)ericsson(.+)"];
...
key.setCaretKey(["C-:"], function (ev, arg) {
                shell.input(null, arg);
            }, 'List and execute commands', true);
